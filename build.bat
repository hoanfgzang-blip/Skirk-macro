...
echo.
echo [1/2] Building Python backend (main.exe)...
cd build
call pyinstaller --onefile --workpath "temp" --distpath "dist" "..\src\macro\main.py"
if %errorlevel% neq 0 (
    echo.
...
echo   App is located in: build\app\win-unpacked\ui.exe
echo ===================================
pause
